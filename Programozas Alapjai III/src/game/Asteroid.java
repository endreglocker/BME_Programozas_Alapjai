...
public class Asteroid extends Thing {
    ...
    public Asteroid(Random random) {
        super(spawnPosition(random), spawnVelocity(random), AsteroidSize.Large.radius, AsteroidSize.Large.scoreForKilling);
     ...
     */
    private static DescartesVector spawnPosition(Random random) {
        ...
        DescartesVector vec = new DescartesVector(halfMaxDistance, minDistance);
