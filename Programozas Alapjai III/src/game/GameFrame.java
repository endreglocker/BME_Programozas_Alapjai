...
public class GameFrame extends JFrame {
    ...
    public JMenuBar jMenuBar() {
        ...
        JMenuItem mainMenu = new JMenuItem("Return to Menu");
        JMenuItem restart = new JMenuItem("Restart");

        exit.addActionListener(new SaveAndExitAction(this));
        mainMenu.addActionListener(new ReturnToMainMenu(this));
    ...
    public class ReturnToMainMenu implements ActionListener {
        ...
        public ReturnToMainMenu(GameFrame f) {
            frame = f;
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            */
            ...
            // closing the frame
            frame.dispose();//dispatchEvent(new WindowEvent(frame, WindowEvent.WINDOW_CLOSING));//dispose(); // dispose does not work somehow
        }
    }
